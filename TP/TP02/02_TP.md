...
Le texte est représenté entre guillemets " donc par exemple "bonjour", ou "42". En anglais guillemets = double quote. Mais les guillemets ne sont pas écrits en mémoire, "42" occuperont deux octets de code décimal 52 et 50.
...
> int : variable de type calcul entier sur 32 bits soit 4 octets
...
> Quand tu ajoutes du texte avec le signe +, cela assemble les deux textes entre eux pour ne former qu'un seul texte.
